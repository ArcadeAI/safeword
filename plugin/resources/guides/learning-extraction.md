...
**LLM Instruction Design:** Learnings are documentation that LLMs read and follow. Apply best practices from `@"${CLAUDE_PLUGIN_ROOT}"/resources/guides/llm-writing-guide.md` when writing learning files (concrete examples, explicit definitions, MECE principles).

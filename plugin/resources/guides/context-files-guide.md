...
@"${CLAUDE_PLUGIN_ROOT}"/resources/guides/llm-writing-guide.md
...
**See:** `@"${CLAUDE_PLUGIN_ROOT}"/resources/guides/llm-writing-guide.md` for core principles and quality checklist.

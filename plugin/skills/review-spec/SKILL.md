...
`bun "${CLAUDE_PLUGIN_ROOT}"/runtime/hooks/write-review-stamp.ts --review-id "review_id" --independence "independence" --author-agent "author_agent" --reviewer-agent "actual_reviewer" --model "reviewer_model" --phase scenario-gate`.

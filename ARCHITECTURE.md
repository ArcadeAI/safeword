...
| Trade-off      | Every supported writer must honor the same locking and compatibility protocol, and retained events can increase read cost. Local filesystems lacking exclusive creation and atomic same-directory rename fail closed. Contention, stale-lease recovery, and ledger growth must remain observable assessment triggers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

...
| Alternatives   | Separate TDD skill with handoff (rejected: soft enforcement), subagent delegation (rejected: no nesting) _[update 2026-06-24: subagent nesting now exists (CC v2.1.172, ≤5 deep), so that rationale is obsolete — but the decision stands on soft enforcement, which is unchanged]_                                                                                  |

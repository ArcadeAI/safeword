...
| Implementation | Epic `P0D6S2` / issue #1909, phased into MVP `HXT3GW`, freshness/noise child `Z7M7Y3`, and controlled-execution child `436EQW`. MVP plans `packages/cli/src/pr-review/`, a typed `review-pr` command, one schema-managed workflow, deterministic contract/wiring tests, and guarded `.flux` and disposable-GitHub evaluations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

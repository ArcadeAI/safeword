 ...
 * how to select them; the harness CONSUMES it off the pack (harness → pack pull).
 * It knows nothing of prompts, hooks, or timing.
 *
...
export const pythonSkillManifest: PackSkillManifest = {

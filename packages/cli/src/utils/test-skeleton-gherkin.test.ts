/**
 * Unit tests for the Gherkin renderer (ticket 102a — gherkin-typescript.DEV1.AC1).
 *
...
describe('emitGherkinFeature — AC1: faithful Gherkin emission', () => {
  ...
  it('gherkin-typescript.DEV1.AC1.lineage_becomes_a_tag', () => {
    ...
    expect(lines[scenarioIndex - 1]?.trim()).toBe('@gherkin-typescript.DEV1.AC1');
  });
  ...
  it('gherkin-typescript.DEV1.AC1.hostile_title_emits_a_valid_feature', () => {
    ...
    expect(s?.tags).toEqual(['@gherkin-typescript.DEV1.AC1']);

...
function launchReviewWorker(input: {
  ...
  return spawn(
    ...
    ],
    {
      ...
      detached: true,
      // The detached worker owns this inherited descriptor after the launcher exits;
      // coordinator writes are best-effort, so a closed downstream pipe cannot fail the job.

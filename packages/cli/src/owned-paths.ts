 ...
 * hook to identify files to stage after `safeword setup` runs.
 *
...
// Regenerated on every \`safeword setup\`.
 ...
 * Used by the auto-upgrade hook to decide what to stage after \`safeword setup\`.
 */

...
const CANONICAL_COMMANDS: readonly CommandDefinition[] = [
  ...
  command('review-pr', 'Review a GitHub pull request', 'mutate', {
    networkPolicy: 'declared',
    commandOptions: [
      { flags: '--repository <owner/repo>', description: 'GitHub target repository' },
      { flags: '--pull <number>', description: 'GitHub pull request number' },
    ],
  }),

...
```bash
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.1/runtime/cli.js" project runtime cleanup-zombies --
```

If the preview looks correct, confirm the kill with `--yes`:

```bash
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.1/runtime/cli.js" project runtime cleanup-zombies -- --yes
```
...
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.1/runtime/cli.js" project runtime cleanup-zombies -- 5173

# Port + additional pattern
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.1/runtime/cli.js" project runtime cleanup-zombies -- --yes 5173 "electron"
```

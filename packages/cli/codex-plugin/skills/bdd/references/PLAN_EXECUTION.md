...
```bash
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.5/runtime/cli.js" project runtime write-review-stamp -- --author-agent "<author-agent>" --reviewer-agent "<actual-reviewer>" --independence "<independence>" --review-id "<review-id>" --phase plan-execution
```

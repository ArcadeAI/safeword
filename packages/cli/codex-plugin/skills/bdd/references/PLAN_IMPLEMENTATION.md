...
1. **Independent review first.** At review time, run `safeword project review-knowledge --json`. Resolve a review-capable Safeword CLI, then invoke the coordinator with the current files identified by the resolver:

...
```sh
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.4/runtime/cli.js" project runtime closeout-cleanup -- --pr PR_NUMBER
```
...
```sh
bun "${CODEX_HOME:-$HOME/.codex}/plugins/cache/safeword/safeword/1.0.0-rc.4/runtime/cli.js" project runtime closeout-cleanup -- --pr PR_NUMBER --yes --plan PLAN_DIGEST
```

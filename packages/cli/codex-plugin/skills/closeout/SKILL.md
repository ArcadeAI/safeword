...
```sh
bunx --bun safeword@0.82.1 project runtime closeout-cleanup --pr PR_NUMBER
```
...
```sh
bunx --bun safeword@0.82.1 project runtime closeout-cleanup --pr PR_NUMBER --yes --plan PLAN_DIGEST
```

...
`bunx --bun safeword@0.78.7 project review-knowledge --json` and read the current
...
```bash
SAFEWORD_REVIEW_PROGRESS=1 bunx --bun safeword@0.78.7 review run scenario-gate feature-file ticket-spec [legacy-test-definitions] --agent-handoff --json
```

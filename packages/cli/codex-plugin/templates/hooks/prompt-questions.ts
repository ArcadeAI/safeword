    ...
    if (state.activeTicket) {
      ...
      if (phase && isActive) {
        ...
        const reminders: Record<string, string> = {
          ...
          'plan-implementation':
            'Phase: plan-implementation. Author impl-plan.md (scaffold from .safeword/templates/impl-plan-template.md); map installed language/component skills to the scenarios; independent review before advancing to plan-execution.',
          'plan-execution':

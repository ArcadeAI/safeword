  ...
  Rule: codex-continuity.NTB1.R1 — Every migration state names protection and one next action
    ...
    Scenario Outline: Human status gives one safe next action for settled migration states
      ...
      Examples:
        ...
        | restart pending without legacy | plugin_installed_app_restart_required | unprotected | Fully restart Codex, then resume this task and review the installed hooks with /hooks. |
        | restart pending with complete legacy | plugin_installed_app_restart_required | protected | Fully restart Codex, then resume this task and review the installed hooks with /hooks. |
        | restart pending with partial legacy | plugin_installed_app_restart_required | partial | Fully restart Codex, then resume this task and review the installed hooks with /hooks. |
    ...
    Scenario Outline: Domain status uses state-specific complete schema
      ...
      Examples:
        ...
        | restart pending without legacy | plugin_installed_app_restart_required  | unprotected | 1            | Fully restart Codex, then resume this task and review the installed hooks with /hooks. | 2         |
        | restart pending with complete legacy | plugin_installed_app_restart_required | protected | 1            | Fully restart Codex, then resume this task and review the installed hooks with /hooks. | 2         |
        | restart pending with partial legacy | plugin_installed_app_restart_required | partial | 1            | Fully restart Codex, then resume this task and review the installed hooks with /hooks. | 2         |
        | complete legacy                | legacy                             | protected   | 1            | safeword codex migrate             | 2         |
        | partial legacy                 | legacy                             | partial     | 1            | safeword codex migrate             | 2         |
        | unproven without legacy        | plugin_enabled_hook_unproven       | unprotected | 1            | Fully restart Codex, then resume this task and review the installed hooks with /hooks. | 2         |
        | unproven with legacy           | plugin_enabled_hook_unproven       | protected   | 1            | Fully restart Codex, then resume this task and review the installed hooks with /hooks. | 2         |

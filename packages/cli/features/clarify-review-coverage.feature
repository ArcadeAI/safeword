...
Feature: Make review coverage clear without false alarms
  ...
  Scenario Outline: Real machine envelopes retain the pre-vocabulary schema
    ...
    Examples:
      ...
      | approved          | healthy         | approved          | degraded     | codex  | claude   | approve         | actual_reviewer,assigned_reviewer,author_agent,command,independence,independent_fallback_failure,preferred_failure,preferred_model,reviewer_output,status                                                       |
      | changes_requested | action_required | changes_requested | degraded     | codex  | claude   | request_changes | actual_reviewer,alternate_model,alternate_model_failure,assigned_reviewer,author_agent,command,independence,independent_fallback_failure,preferred_failure,preferred_model,reviewer_output,status               |
      | blocked_degraded  | action_required | blocked           | degraded     | codex  | claude   | request_changes | actual_reviewer,alternate_model,alternate_model_failure,assigned_reviewer,author_agent,command,independence,independent_fallback_failure,preferred_failure,preferred_model,review_policy,reviewer_output,status |
      | exhausted         | action_required | blocked           | none         | absent | claude   | absent          | alternate_model,alternate_model_failure,assigned_reviewer,author_agent,command,fallback_failure,independence,independent_fallback_failure,preferred_failure,preferred_model,review_policy,status                |

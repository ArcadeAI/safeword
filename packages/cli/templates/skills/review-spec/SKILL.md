...
```bash
bun .safeword/hooks/run-review.ts review run scenario-gate feature-file [legacy-test-definitions] --context ticket-spec [parent-spec] [dimensions-file] principles-file personas-file surfaces-file --agent-handoff --json
```

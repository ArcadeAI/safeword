...
const LANGUAGE_CASES = [
  {
    ...
    expectedWarning:
      'TypeScript Safeword config is missing — linting with ESLint defaults, not Safeword rules. Run `safeword install` to install it.',
  ...
  },
  {
    ...
    configRelativePath: undefined,
    expectedWarning:
      'Python Safeword config is missing — linting with Ruff defaults, not Safeword rules. Run `safeword install` to install it.',
    forbidConfigArgument: true,
    stubCommands: ['ruff'],
    expectedInvocations: [
  ...
  },
  {
    ...
    configRelativePath: undefined,
    expectedWarning:
      'Go Safeword config is missing — linting with golangci-lint defaults, not Safeword rules. Run `safeword install` to install it.',
    forbidConfigArgument: true,
  ...
  },
  {
    ...
    configRelativePath: undefined,
    expectedWarning:
      'Rust Safeword config is missing — linting with rustfmt defaults, not Safeword rules. Run `safeword install` to install it.',
    forbidConfigArgument: true,

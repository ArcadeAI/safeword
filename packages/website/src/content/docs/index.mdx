...
Works with **Cursor** and **Claude Code**. Auto-detects **TypeScript**, **Python** (beta), **Go** (beta), **Rust** (beta), **SQL/dbt** (beta).
...
Under the hood, your agent now moves through five phases — clarify, classify, build, verify, done — with gates that stop it skipping straight to "done." See [The Workflow](/getting-started/workflow).

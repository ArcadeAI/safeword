...
`ingest` role. That role can submit collector-owned findings for filing through
the fixed GitHub App installation and repository, but cannot reconcile, recover,
or inspect other relay records. Every principal is bound to the configured

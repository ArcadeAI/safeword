...
- **Capability Claims Need Vendor Docs (Our Code Is Not Authority on Their Capability)** — claim provenance, external-system capabilities, stale-snapshot trust, load-bearing-premise decay, capability negatives.
  → `.project/learnings/capability-claims-need-vendor-docs.md`
...
- **Dependency Claims Are Consumer-Scoped, Not Lockfile-Scoped** — dependency bump descriptions, transitive dependencies, monorepo lockfile vs published package graph, native bindings.
  → `.project/learnings/dependency-claims-are-consumer-scoped.md`
...
- **Skill-Pack Efficacy Gate: Prove Behavior Change, Not Provenance** — skill-pack adoption gate, efficacy eval, headroom probe, deterministic grader, control-vs-treatment, picker-cost, experiments/ harness role.
  → `.project/learnings/skill-pack-efficacy-gate.md`

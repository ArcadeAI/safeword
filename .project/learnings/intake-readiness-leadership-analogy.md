# Intake & Readiness: The Leadership Analogy
...
Best intake model is the **mission-command IC**: clarify intent and end-state to the point of disciplined initiative, scale clarification depth to readiness × blast radius, keep asking cheap — not the diligent junior who asks everything, nor the cowboy who just runs.

## Sources

- US Army, "Understanding mission command" — https://www.army.mil/article/106872/understanding_mission_command
- FBI Law Enforcement Bulletin, "Commander's Intent: A Framework for Success" — https://leb.fbi.gov/articles/featured-articles/commanders-intent-a-framework-for-success
- Thayer Leadership, "Managing Your Boss with Mission Command" — https://thayerleadership.com/leadership-blog/managing-your-boss-with-mission-command/
- Situational Leadership (Center for Leadership Studies) — https://situational.com/situational-leadership/
...
- Psych Safety, "Google's Project Aristotle" — https://psychsafety.com/googles-project-aristotle/
- ThriveSparrow, "Traits of High-Performing Employees" — https://www.thrivesparrow.com/blog/characteristics-of-high-performing-employees

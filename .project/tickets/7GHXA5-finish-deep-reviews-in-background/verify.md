...
**Evidence limits:** ⚠️ Historical RED commits are unavailable because the initial implementation and proof landed together; this is recorded as a process deviation in `test-definitions.md` rather than claimed as conforming TDD evidence.

...
#### feature-files-as-source.SM1.R1 - Coverage reads lineage from Gherkin tags
...
#### feature-files-as-source.SM1.R2 - Codify derives implementation stubs from feature source
...
#### feature-files-as-source.SM1.R3 - Authoring and review instructions point to one behavior source
...
#### feature-files-as-source.SM1.R4 - Existing markdown tickets continue working

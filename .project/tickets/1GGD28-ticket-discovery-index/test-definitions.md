...
- [x] cross-scenario skip: module is already small and single-purpose; a shared abstraction with learning-sync would be premature (the two differ on grouping, two-file split, and frontmatter vs Covers-line parsing).

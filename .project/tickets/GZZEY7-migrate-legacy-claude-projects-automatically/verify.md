...
| Claude Code | Full non-live Cucumber lane plus proof-tag lane and generated dispatcher/migration tests | ✅ 1,535 scenarios and 65,484 steps passed across acceptance and proof lanes. |

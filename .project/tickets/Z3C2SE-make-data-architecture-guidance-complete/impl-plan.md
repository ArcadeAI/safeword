...
| --- | --- | --- | --- | --- | --- | --- |
| https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents and https://openai.com/index/trustworthy-third-party-evaluations-foundations/ | 2026-09-16 | Anthropic article published 2026-01-09; OpenAI foundation published 2026 | Safeword 1.0.0-rc.3 | Anthropic separates tasks, trials, graders, and transcripts and recommends unambiguous success criteria; OpenAI treats harness details and validity checks as part of the result | Keep cases, trials, grading, and recorded provenance separate; bind the harness inputs needed to judge validity | Sources describe general eval systems, not this repository; no source code is reused and no credentials, private code, or customer data were sent |

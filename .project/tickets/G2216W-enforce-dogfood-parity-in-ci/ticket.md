...
- 2026-07-25T15:11:00Z Configured: Added GitHub Actions `Dogfood parity` (integration 15368) to the active `main branch protection` ruleset as a required status check; first PR run passed.
- 2026-07-25T15:09:30Z Improved: Replaced free-form RGR annotations with the ledger's durable commit/skip format so commit and push gates stay clean.

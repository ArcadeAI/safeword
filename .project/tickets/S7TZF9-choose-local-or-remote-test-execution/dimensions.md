...
| --- | --- |
| Preference source | command override; personal config; project default; built-in local |
...
| Observable output | effective mode and origin; local fallback reason; invalid-config error |

# Test Definitions: Make planning gates understandable and scope-safe

Feature source: `features/make-planning-gates-understandable-and-scope-safe.feature`
...
### Scenario: Installed review dispatch enforces scope completeness
...
### Scenario: Interactive approval behavior follows the gate setting
...
### Scenario: Granted human approval clears the installed approach gate
...
### Scenario: Cloud hosts reject agent-written approval claims
...
### Scenario: Headless approval exits cleanly through the real host lifecycle
...
### Scenario: Review invalidation names only the plans affected by a changed decision
...
### Scenario: A non-technical builder can recover from each new message category
...
### Scenario: Recovery messages remain plain at cloud host boundaries

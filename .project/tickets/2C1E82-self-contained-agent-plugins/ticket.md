...
- 2026-09-02T20:50:10.000Z Third independent scenario review approved the corrected spec/feature lineage. Applied its three non-blocking clarity improvements: explicit real-dispatch proof boundaries for Claude and OpenCode, complete native-host surface tags on mixed selection, and an NTB1.R1 outcome limited to selected profile delivery while NTB1.R2 retains catalogue completeness.

# Test Definitions: Learn from exceptional products

Feature source: `packages/cli/features/learn-from-exceptional-products.feature`

This is the RED / GREEN / REFACTOR ledger. Scenario prose lives in the feature
source; ticks remain open until the corresponding proof exists and passes.

## Rule: learn-from-exceptional-products.TBU1.R1 — A confirmed customer job frames product inspiration before Rules
...
## Rule: learn-from-exceptional-products.TBU1.R2 — Validated scenarios and bounded constraints frame implementation inspiration
...
## Rule: learn-from-exceptional-products.TBU1.R3 — Every record separates evidence, principle, boundary, and impact
...
## Rule: learn-from-exceptional-products.TBU1.R4 — Routine inspiration stays out of TDD loops and significant choices prompt refresh
...
## Rule: learn-from-exceptional-products.NTB1.R1 — Every surface receives both stages by default at its available enforcement level
...
## Rule: learn-from-exceptional-products.NTB1.R2 — Each synthesis plainly explains what Safeword learned and changed
...
## Rule: learn-from-exceptional-products.NTB1.R3 — Neither decision stage exits without resolved evidence

...
- **Tracker connect/onboarding flow — interactive wiring (when + where the human authorizes) (2TK5AD)** (blocked, epic: —)
...
- **Speed up the vitest suite — lift blanket maxWorkers:1, isolate the offenders (CQJBSN)** (backlog, epic: —)

...
- **safeword sync-tracker — one-way projection to Linear + GitHub Issues (JS5K5G)** (in_progress, epic: —)
  ...
  blocks: Breach issue projection — signal breach → tracker issue (deferred stub) (K51FYZ), sync-tracker v2 — project the dependency graph (relations, sub-issues, types) (M1FGRJ)

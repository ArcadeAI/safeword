...
- 2026-08-21 Verification reconciliation: regenerated the CLI reference and classified FFXB81 as `@proof.vitest` with a complete proof manifest. Its documentation, proof-contract, and lifecycle suites pass 94 tests. The repository-wide Cucumber lane still reports undefined scenarios in separate remote-testing tickets and other unfinished features; those were not folded into this historical-migration ticket.

...
> Rationale: TB1.AC1 — migration is the recommended default at the natural
> touchpoint (upgrade), one keystroke to accept.

### Scenario: upgrade-namespace-migration.TB1.AC1.flag_migrates_legacy_install
...
### Scenario: upgrade-namespace-migration.TB1.AC1.prompt_accept_migrates
...
### Scenario: upgrade-namespace-migration.TB1.AC1.untracked_dir_falls_back_to_rename
...
> Rationale: TB1.AC2 — driver-locked: default and recommended, never silent,
> never forced. Declining costs nothing.

### Scenario: upgrade-namespace-migration.TB1.AC2.prompt_decline_leaves_legacy_untouched
...
### Scenario: upgrade-namespace-migration.TB1.AC2.decline_flag_skips_prompt_and_move
...
### Scenario: upgrade-namespace-migration.TB1.AC2.non_interactive_nudges_only
...
### Scenario: upgrade-namespace-migration.TB1.AC2.move_failure_reports_and_changes_nothing
...
### Scenario: upgrade-namespace-migration.TB1.AC2.current_install_gets_no_offer
...
> Rationale: TB1.AC3 — the same run finishes on the new root; nothing keeps
> pointing at the old one.

### Scenario: upgrade-namespace-migration.TB1.AC3.same_run_reconciles_on_new_root
...
### Scenario: upgrade-namespace-migration.TB1.AC3.stale_per_file_overrides_rewritten
...
### Scenario: upgrade-namespace-migration.TB1.AC3.configured_custom_root_not_offered
...
> Rationale: TB1.AC4 — both-dirs is transient; the tooling names the
> finishing action instead of silently picking forever.

### Scenario: upgrade-namespace-migration.TB1.AC4.both_dirs_refuses_move_and_advises
...
### Scenario: upgrade-namespace-migration.TB1.AC4.check_advisory_fires_on_both_dirs
...
### Scenario: upgrade-namespace-migration.TB1.AC4.check_silent_on_single_root

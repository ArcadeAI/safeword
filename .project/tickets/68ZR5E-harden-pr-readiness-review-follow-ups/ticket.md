...
**Goal:** Resolve the six non-blocking hardening opportunities identified by the final PY73VN independent reviews.

**Why:** Keep the completed feature focused while preserving concrete follow-up work on receipt integrity, install wiring proof, recovery copy, Cursor loading, and architecture scope.

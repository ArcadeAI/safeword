...
- After independent re-review, the headless environment is agent-scoped: Claude and Codex receive only their own credential families, while Cursor receives common runtime values and no vendor credentials. The focused regression suite passed 95/95 and lint/typecheck remained green.

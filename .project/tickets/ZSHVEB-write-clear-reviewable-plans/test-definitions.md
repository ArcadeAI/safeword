# Test Definitions: Make Safeword plans clear and reviewable

Feature source: `features/write-clear-reviewable-plans.feature`
...
### Scenario: Both planning stages use the same decision-conversation contract
...
### Scenario: Each decision is recorded in its owning plan
...
### Scenario: A changed decision returns to the earliest affected plan

...
### Scenario: keep-upgrade-success-on-health-warnings.TB1.AC1.upgrade_reports_existing_health_issues_without_failing
...
### Scenario: keep-upgrade-success-on-health-warnings.TB1.AC2.check_keeps_nonzero_exit_for_existing_health_issue

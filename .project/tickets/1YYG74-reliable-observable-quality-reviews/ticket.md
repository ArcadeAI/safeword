...
- 2026-08-13T14:25:00.000Z REVIEW: Reconciled the documented `preferred_failure` contract with the complete runtime taxonomy, adding process, provenance, and source-change classifications that were already implemented and proven by lower-level tests.

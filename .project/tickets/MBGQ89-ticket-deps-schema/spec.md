...
#### ticket-deps-schema.TB1.AC1 — optional canonical fields
...
#### ticket-deps-schema.TB1.AC2 — relations validation is warn-only
...
#### ticket-deps-schema.TB1.AC3 — blocked_on gates phase-advance out of intake
...
#### ticket-deps-schema.TB1.AC4 — terminal-but-not-done needs a reasoned override
...
#### ticket-deps-schema.TB1.AC5 — the gate fires only on the intake-exit transition

...
authoritative, and includes it in the bounded packet. The reviewer blocks an
unlinked candidate, a second candidate claiming design authority, or a required
decision that the plan neither names nor routes into that packet. This proves
configured project authority, not discovery of arbitrary files outside it.
...
| R3 mental model and focused reviewability                          | Real review coordinator with bounded project-local packet                                                                                                                   | Deterministic contract-conformance integration plus a current-revision independent-review acceptance artifact                                                                                                                                                             | The fixture discriminates decision-first summaries from execution-first plans; live reviewer consistency remains variable, so unavailable exact-contract acceptance is reported honestly rather than inferred.                                                                                                                                                                                                                                                                                                                                                                                     |
...
5. **Partly implemented; expanded proof open:** carry the phase, contract, configured-architecture edit exception, canonical
   ...
   R4, R7, and R15 boundaries there, including distinct Non-Technical Builder
   and Technical Builder receipt projections.

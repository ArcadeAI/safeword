...
last_modified: 2026-09-06T13:21:32.000-07:00
---
...
- 2026-09-06T13:21:32.000-07:00 Claude Code production GREEN: Commit `1bd9442795a5f2bdf349706055e07fd7c546b2c0` had no tracked source changes when its canary-scoped CLI was built (SHA-256 `dafadd2b2b92396c643c13740d483ae025ffa227793234f84fc4d28ed9f2755e`) and run through a real interactive Claude Code 2.1.226 session and its normal Stop hook. The Claude source was pinned to `server-v3`; direct filing and direct agent-side GitHub creation were not invoked. Request `ea69af2d-159e-4460-ac52-5f2f64b5d24b` received collector receipt `d94059ab-4bbe-4b9d-af16-de55816cabf0` and was filed as synthetic issue #4040. Raw GitHub REST returned request marker `00a64f2b71260eb1e98a3eb5ff9d0f14943d3edef022b196730acb329617d7e0`, exactly matching an independent derivation from the production collector-worker scope and request ID; the synthetic issue was then closed. Claude print mode was ruled out as a canary carrier because it completed the same three tool calls without emitting a Stop hook event. The aggregate SWM1.R1 evidence ledger remains unchecked until Cursor evidence is captured and all three harness artifacts are verified and linked in the readiness manifest. The earlier Codex proof establishes truthful local classification and server routing, but is weaker than Claude's real-session proof; the global verifier must not treat socket presence alone as equivalent real-session evidence. Cursor, fault artifacts, and the authoritative global readiness verifier remain gated.

...
- 2026-09-06T13:21:32.000-07:00 Claude Code production GREEN: A clean build of commit `1bd9442795a5f2bdf349706055e07fd7c546b2c0` (CLI SHA-256 `dafadd2b2b92396c643c13740d483ae025ffa227793234f84fc4d28ed9f2755e`) ran through a real interactive Claude Code 2.1.226 session and its normal Stop hook. Request `ea69af2d-159e-4460-ac52-5f2f64b5d24b` was accepted through `server-v3` with collector receipt `d94059ab-4bbe-4b9d-af16-de55816cabf0` and filed as synthetic issue #4040. Raw GitHub REST returned request marker `00a64f2b71260eb1e98a3eb5ff9d0f14943d3edef022b196730acb329617d7e0`, exactly matching an independent derivation from the production collector-worker scope and request ID; the synthetic issue was then closed. Claude print mode was ruled out as a canary carrier because it completed the same three tool calls without emitting a Stop hook event. Cursor, fault artifacts, and the authoritative global readiness verifier remain gated.

...
# Architecture narrative reconciliation: honor paths.architecture

**Goal:** Done-gate nudge and architecture prompts resolve the narrative via paths.architecture (root ARCHITECTURE.md fallback).

> **Supersession (2026-07-28):** GitHub #1609 retired this ticket's former TB2
> package-mention advisory. `architecture.generated.md` owns structural package
> inventory; the hand-curated narrative records meaningful decisions. The TB2
> material below remains delivery history, not current behavior.
...
- **Advisory reversal (GitHub #1609, 2026-07-28):** retired the every-run
  package-mention check and its AXRC4D deviation. A package absent from a
  decision record is normally valid; generated architecture state remains the
  structural inventory. The original #848 incident and TB2 evidence remain
  historically accurate, but no longer prescribe product behavior.
...
- 2026-07-28T00:00:00Z Superseded: GitHub #1609 retired TB2's every-run package-mention advisory. Removed its runtime, acceptance steps, and scenarios; retained the TB1 configured-narrative contract and documented the reversal above.

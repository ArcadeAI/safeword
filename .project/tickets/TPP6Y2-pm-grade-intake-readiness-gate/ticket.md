...
- **Consulting** → _problem-behind-the-problem_ / request-shape normalization (under-specified non-technical ask vs. solution-in-disguise technical ask). (`intake-readiness-architect-consultant-analogy.md`)

...
| Product definition | accepted persona success; refusal; failure; trust; approval; recovery; explicit inapplicability; technical-choice leakage | Product Bet and TBU4.R14 |
...
| Delivery truth | current implementation; target work; known defect; current, earlier, partial, structural, or missing proof; downstream approval overclaim | TBU2.R12–R14, TBU4.R14 |
...
| Finding dispute | scope; optional strengthening; currency; correctness; upheld, reclassified, rejected, pending, unresolved | TBU5.R1–R5 |
...
| User and host recovery | missing/stale/mismatched context; stale review; task promotion; human approval enabled/disabled/headless; pending scope or dispute; gated and advisory hosts | TBU1.R15–R16, TBU4.R13, NTB1.R1–R4 |

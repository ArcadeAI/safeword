...
| Customer fixture posture | temp project outside dogfood repo, TypeScript setup, Python setup, Go setup, Rust setup, no `.project` assumptions beyond resolver, no SafeWord dogfood-only layout assumptions | TB1.AC1, SM1.AC1, SM1.AC2 |

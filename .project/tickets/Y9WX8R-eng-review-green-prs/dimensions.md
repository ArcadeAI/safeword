...
| ----------------------------- | ----------------------------------------------------------------------------- | --------------------------------------------------- | ------------------- |
| Verdict value                 | APPROVE · REQUEST-CHANGES · NEEDS-DISCUSSION · **invalid**                    | invalid value must be rejected                      | A1; A2              |
...
| Review disposition            | reviewed · **skip(reason)**                                                   | skip requires a non-empty reason to be auditable    | B3                  |

...
5. RED: Add `packages/cli/tests/review/delivery-proof-ledger.test.ts` for
...
11. REFACTOR: Centralize stable-definition and normalized-plan comparison plus
    ...
    JSON/YAML mirror.
12. Run:
   `node ./node_modules/vitest/vitest.mjs run tests/review/execution-plan-output.test.ts tests/review/packet.test.ts tests/review/execution-plan-conformance.test.ts tests/review/delivery-compatibility-conformance.test.ts tests/review/delivery-compatibility-rubric-generation.test.ts tests/cli-protocol/review-wiring.test.ts tests/review/delivery-proof-ledger.test.ts tests/integration/delivery-checklist-cli.test.ts tests/integration/delivery-checklist-update.test.ts tests/integration/delivery-checklist-recovery.test.ts`.
13. Run:
...
| delivery-cli           | command        | E2E         | Public proof ledger, checklist update, and readiness commands                                                                                                                | real_boundary | current_required | {"type":"command","cwd":"packages/cli","argv":["node","./node_modules/vitest/vitest.mjs","run","tests/review/delivery-proof-ledger.test.ts","tests/integration/delivery-checklist-cli.test.ts","tests/integration/delivery-checklist-update.test.ts"]}                                    |

# Test Definitions: Lean Product Plans
...
### Scenario: Work with settled demand does not trigger demand research
...
### Scenario: A referenced parent contract change blocks advancement
...
### Scenario: A non-contract parent change creates no reconciliation work

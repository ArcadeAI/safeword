# Tagged @proof.vitest to exclude this feature from the cucumber acceptance lane: issue-first
...
# packages/cli/tests/tracker-sync/resolve-by-key.test.ts and focused tests for
# ticket-writer-issue-first, ticket-creation-mode,
...
@tracker-identity-and-join @proof.vitest

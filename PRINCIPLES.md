...
| Work after every independent process route is unavailable           | missing feedback       | degraded **review** — same-agent headless, then host-reported fresh context, then bounded self-review; always labeled not independent and honest about live-source limits |

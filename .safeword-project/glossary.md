...
**Definition:** The folder for one unit of multi-step work — `.safeword-project/tickets/{id}-{slug}/` — holding `ticket.md` (frontmatter + work log), `spec.md`, `test-definitions.md`, and `verify.md`. Acts as the context anchor across sessions.

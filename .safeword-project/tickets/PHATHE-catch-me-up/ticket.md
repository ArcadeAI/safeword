...
> Status: **intake**. Records intent + the prior-art tie + open questions. The big one: is this distinct from explain-in-english (NTT094), or the same skill? Converge before building.

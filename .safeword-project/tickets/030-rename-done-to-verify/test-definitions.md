...
- [x] **Given** the distributed command templates
...
- [x] **Given** a project with no active ticket
      **When** running `/verify`
...
- [x] **Given** a project with an active ticket and test-definitions.md
      **When** running `/verify`
...
- [x] **Given** `package.json` has `@tanstack/query` in dependencies
...
- [x] **Given** `package.json` has `vitest` in devDependencies
...
- [x] **Given** a project without ARCHITECTURE.md
      **When** running `/verify`
...
- [x] **Given** a feature ticket in `phase: done`
...
- [x] **Given** the distributed `DONE.md` skill file
...
- [x] **Given** `SAFEWORD_SCHEMA.ownedFiles` in schema.ts
...
- [x] **Given** a consumer project on previous version with `/done`

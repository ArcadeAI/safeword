...
- 2026-06-12T01:55:00Z Latent-failure fix (surfaced by E11N48's full-suite run; NTT094's close had skipped the full suite). Two skills/schema-parity failures: the description lacked a usage trigger word, and there was no cursor-rule mapping. Root reclassification: /explain is a deliberate ACTION skill (like verify/audit), not a context-rule (like brainstorm) — set `disable-model-invocation: true`, `cursorRules: undefined` (fixture + ACTION_SKILLS), reworded the description to lead with "Use when". This also moots the over-trigger risk flagged in the quality-review (it no longer auto-triggers). Full suite green (2621). Commit 5fce14fb.

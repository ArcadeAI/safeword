...
proofs. Lineage: `loc-gate-vs-phase-placement.DEV1.AC<n>.<scenario>`.

## Rule: The detector identifies an in-progress git operation (AC1)

### Scenario: loc-gate-vs-phase-placement.DEV1.AC1.merge_in_progress_is_detected
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC1.rebase_in_progress_is_detected
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC1.cherry_pick_in_progress_is_detected
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC1.revert_in_progress_is_detected
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC1.loc_gate_does_not_arm_mid_merge
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC2.clean_repo_returns_false
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC2.non_git_directory_returns_false
...
### Scenario: loc-gate-vs-phase-placement.DEV1.AC2.loc_gate_still_arms_with_no_operation

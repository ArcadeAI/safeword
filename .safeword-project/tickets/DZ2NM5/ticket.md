...
| **E1K5ZW** | Epic integration: end-to-end Phase 0 worked example + demo                 | —           | Open   | children   |
...
- All child tickets are `done` (product layer: 7YN5QB, YR6C49, Y2HCNJ, 31W8M3, XT1FFM, K7N2QM ✓; remaining: B0JZQN, 1J6JKP, E1K5ZW).
- The merged DISCOVERY.md includes a worked example walkthrough that exercises all four artifact types — tracked by **E1K5ZW**.
- A test (or example ticket) demonstrates the new flow end-to-end — tracked by **E1K5ZW**.

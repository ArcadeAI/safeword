...
- [x] **Given** a fresh `packages/cli/templates/hooks/` directory
...
- [x] **Given** `SETTINGS_HOOKS` in `config.ts`
...
- [x] **Given** `post-tool-quality.ts` registered in `SETTINGS_HOOKS`
...
- [x] **Given** the distributed `pre-tool-quality.ts` template
...
- [x] **Given** a new project running `safeword setup`
...
- [x] **Given** a project on v0.18.0 without quality hooks
...
- [x] **Given** `config.test.ts` SETTINGS_HOOKS tests

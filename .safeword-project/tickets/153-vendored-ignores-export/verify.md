...
- **Outdated:** `eslint 9.39.4 → 10.4.0` (dev, major). Owned by separate in-progress ticket 099-eslint-10-migration — not in scope for 152.
...
1. `dc2e14d` — docs(tickets): add 152 — scenarios, dimensions, ticket

...
- **Spike: port one safeword gate to a Codex PreToolUse deny hook (N12G95)** (in_progress, epic: codex-changelog-alignment)
...
- **Codex commands surface: skills (RESOLVED → skills) (QGHVXZ)** (in_progress, epic: codex-changelog-alignment)
...
- **Pin minimum codex CLI version that supports required hooks (WR4HRA)** (in_progress, epic: codex-changelog-alignment)
...
- **Wire scenario-gate fork review to the cross-model knob (7A0B2K)** (backlog, epic: —)
  ...
  → `.safeword-project/tickets/7A0B2K-scenario-review-cross-model`

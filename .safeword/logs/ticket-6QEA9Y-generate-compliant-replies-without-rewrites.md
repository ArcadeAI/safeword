...
- [00:36] Remediated all five: split reply delivery into an under-cap SessionStart value, derived prompts and validation from one grammar object, covered nested list and HTML declaration/PI/CDATA blocks, counted actual parser passes, and executed both configured legacy and generated-plugin event groups. Expanded acceptance passes 80/80 scenarios (3,036 steps); focused parser tests pass 56/56 and hook integration passes 6/6.

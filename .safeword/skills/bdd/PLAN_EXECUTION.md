...
```bash
bun .safeword/hooks/write-review-stamp.ts --author-agent "<author-agent>" --reviewer-agent "<actual-reviewer>" --independence "<independence>" --review-id "<review-id>" --phase plan-execution
```

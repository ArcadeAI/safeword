...
Scaffold `impl-plan.md` next to `ticket.md` from `.safeword/templates/impl-plan-template.md`, status `planned`. Sections stay **content-or-skip** — every section gets real content or `skip: <non-empty reason>`:
